...
$data_json=file_get_contents('data.json');// //Đọc file json
$result_json= json_decode($data_json,true);// //chuyển json sang dạng mảng
...
if(isset($_POST['sbm'])){
    ...
    if($file_error > 0){
        ...
        $json_en = json_encode($result_json,JSON_UNESCAPED_UNICODE);// //ghi file json: dữ liệu cũ sẽ bị thay thế bằng dữ liệu mới
        file_put_contents('data.json', $json_en);// //đưa dữ liệu vào json
